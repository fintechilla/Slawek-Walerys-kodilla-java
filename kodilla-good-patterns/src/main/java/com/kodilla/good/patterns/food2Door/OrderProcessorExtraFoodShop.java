...
public class OrderProcessorExtraFoodShop implements OrderProcessorInterface {
    private InfoService informationService;
    private OrderService orderService;
    private OrderRepository orderRepository;

    public OrderProcessorExtraFoodShop(final InfoService informationService,
    ...
    public OrderDto process(OrderRequest orderRequest) {
        ...
        if (isOrdered) {
            System.out.println("ExtraFoodShop processing own process...");
