...
public class ApplicationForumUser {
    public static void main(String[] args){
        ...
        System.out.println("user1 location: " + user1.getLocation());
        System.out.println("user1 List: " + user1.getFriends().stream().flatMap(x->x.getFriends().stream())
        .map(x->x.getLocation()).collect(Collectors.toList()));
        System.out.println("Locations of: " + user1.getUserName().toString() + " " + user1.getLocationsList(user1));
        System.out.println("user1 Set: " + user1.getFriends().stream().flatMap(x->x.getFriends().stream())
                .map(x->x.getLocation()).collect(Collectors.toSet()));
//        List<ForumUser> friends = new ArrayList<>();
//        friends.add(user1);
//        friends.add(user2);
//        friends.add(user3);
//        friends.add(user4);
