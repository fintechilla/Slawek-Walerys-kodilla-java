...
public class CustomerTestSuite {
    ...
    public void testDefaultInvestingStrategies() {
        ...
        System.out.println("John shold: " + johnShouldBuy);
    ...
    public void testIndividualInvestingStrategy() {
        ...
        String stevensNewStrategy = steven.predict();
        System.out.println("Steven now should " + stevensNewStrategy);
        //Then
        Assert.assertEquals("[Aggressive predictor] Buy stock of XYZ", stevensNewStrategy);
    }
}
