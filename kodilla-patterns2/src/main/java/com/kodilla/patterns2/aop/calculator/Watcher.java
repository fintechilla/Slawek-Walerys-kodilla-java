...
public class Watcher {
    ...
    private static final Logger LOGGER2 = LoggerFactory.getLogger(com.kodilla.patterns2.aop.calculator.Watcher.class);
    @Before("execution(* com.kodilla.patterns2.facade.api.OrderFacade.processOrder(..))"+ "&& args(theNumber) && target(o)")
    public void logEvent2(Long theNumber, Object o){
        LOGGER2.info("Class: " + o.getClass().getName() + ", Args: " + theNumber);
    }
